...
const ABOUT_APPLICATION_NAME = "OmpCode Desktop App";
...
> = {
  "zh-CN": {
    aboutTitle: "关于 OmpCode",
    versionLabel: "版本",
    okButtonLabel: "确定",
    optimizedForAppleSilicon: "已针对 Apple Silicon 优化。",
    copyright: (year) => `版权所有 © ${year} OmpCode。`,
  },
  "en-US": {
    aboutTitle: "About OmpCode",
    versionLabel: "version",
    okButtonLabel: "OK",
    optimizedForAppleSilicon: "Optimized for Apple Silicon.",
    copyright: (year) => `Copyright © ${year} OmpCode.`,
  },
};
