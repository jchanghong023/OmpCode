/** 中文翻译 */
import ompZhCNOverrides from "./omp-zh-CN.js";
...
const zhCN: Record<string, string> = {
  ...
  "settings.skills.description":
    "查看当前工作区 omp 可调用的技能；聊天中可通过 $skill-name 选择可调用技能。",
  ...
  "chat.goal.objectiveRequired": "请输入目标内容。",
  "chat.goal.unsupported": "当前 Agent 不支持此目标操作：{action}。",
  "chat.goal.commandRejected": "目标操作未执行：{reason}。",
  ...
  "chat.attachments.truncated": "内容过长，已截断",
  ...
  "chat.mention.subagents.source.workspace": "工作区",
  "chat.mention.subagents.source.plugin": "插件",
  "chat.mention.subagents.source.builtIn": "内置",
  "chat.mention.subagents.source.user": "用户",
  ...
  "chat.mention.sessions.untitled": "未命名会话",
