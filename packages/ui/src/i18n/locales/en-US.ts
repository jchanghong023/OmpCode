...
const enUS: Record<string, string> = {
  ...
  "settings.skills.description":
    "Skills come from the current target's omp command catalog. Select them in chat with $ or /skill:.",
  ...
  "chat.attachments.truncated": "Content truncated due to length",
  ...
  "chat.mention.subagents.source.workspace": "Workspace",
  "chat.mention.subagents.source.plugin": "Plugin",
  "chat.mention.subagents.source.builtIn": "Built-in",
  "chat.mention.subagents.source.user": "User",
  ...
  "chat.mention.sessions.untitled": "Untitled session",
