...
const BUILTIN_SKILL_DESCRIPTIONS: Record<string, Record<Locale, string>> = {
  ...
  "control-browser": {
    "zh-CN": "控制 OmpCode 内置浏览器，用于打开、检查、点击、输入、截图或验证网页和本地开发页面。",
    "en-US":
      "Control OmpCode's built-in browser to open, inspect, click, type, screenshot, or verify webpages and local development targets.",
  },
  ...
  "plugin-creator": {
    "zh-CN": "创建、校验 OmpCode 插件，并指导本地安装与更新。",
    "en-US": "Create and validate OmpCode plugins, and guide local installation and updates.",
  },
  "skill-creator": {
    "zh-CN":
  ...
  "web-gui-tester": {
    "zh-CN":
      "使用 OmpCode Browser Use 对网页和本地 Web 前端执行纯 GUI 黑盒测试，通过真实用户交互、DOM 语义证据和截图验证功能、交互与响应式布局。",
    "en-US":
      "Run pure GUI black-box tests against websites and local web frontends with OmpCode Browser Use, combining real user interactions, semantic DOM evidence, and inspected screenshots.",
  },
  "writing-plans": {
